...
/*   Updated: 2018/04/25 20:10:33 by mguyout          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_check_object(t_rt *rt, t_coo dir)
{
	rt->inter->dst = MAX;
	rt->inter->obj = 0;
	rt->inter->angle->dir = dir;
	rt->inter->num = 0;
	...
	if (rt->inter->reflex > 0 && rt->depth < 3)
	{
		rt->depth++;
		rt->inter->reflex = 0;
